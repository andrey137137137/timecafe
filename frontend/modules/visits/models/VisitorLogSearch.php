...
class VisitorLogSearch extends VisitorLog
{
  ...
  {
    return [
      [['id', 'user_id', 'type', 'cafe_id','certificate_type', 'guest_m', 'guest_m_from', 'guest_m_to', 'guest_chi', 'guest_chi_from', 'guest_chi_to', 'chi', 'chi_from', 'chi_to', 'pre_enter', 'pre_enter_from', 'pre_enter_to', 'kiosk_disc', 'kiosk_disc_from', 'kiosk_disc_to', 'terminal_ans','status','pay_state'], 'integer'],
  ...
  public function search($params)
  {
    ...
    $query->andFilterWhere([
        ...
        if(isset($this->sum_to)){
  	     $query
            ->andFilterWhere(['>=', 'sum', (float)$this->sum_from])
            ->andFilterWhere(['<=', 'sum', (float)$this->sum_to])
